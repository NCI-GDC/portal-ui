  ...
  <Column spacing={theme.spacing}>
    <EntityPageVerticalTable
      ...
      thToTd={[
        ...
        { th: 'Entity UUID', td: <CaseLink id={node.case_id}>{node.entity_id}</CaseLink> }, // TODO: link to Biospec section
        { th: 'Entity Barcode', td: node.entity_submitter_id },
        { th: 'Entity type', td: node.entity_type },
        { th: 'Case UUID', td: <CaseLink id={node.case_id}>{node.case_id}</CaseLink> },
        { th: 'Case Submitter ID', td: node.case_submitter_id },
        { th: 'Project ID', td: <ProjectLink id={node.project.project_id}>{node.project.project_id}</ProjectLink> },
