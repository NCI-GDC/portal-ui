...
const FrequentMutations = ({
  ...
  const bandWidth = ((width - chartMargin.right - chartMargin.left) / (frequentMutationsChart.length + 1) / (showSurvivalPlot ? 2 : 1)) * 0.7;

  return (
    <Column>
      {!!frequentMutationsChart.length &&
        <div>
          <Row
            style={{
            ...
            <span style={{ flex: 1 }}>
              <div style={{ textAlign: 'right', marginRight: 50, marginLeft: 30 }}>
                <DownloadVisualizationButton
                  ...
                  data={frequentMutationsChart.map(fm => _.omit(fm, 'consequence_type'))}
                  slug="bar-chart"
                  noText
          ...
          <MutationTable
            ...
            frequentMutations={frequentMutationsTable}
