...
const Case = compose(
  ...
  const fmFilters = makeFilter([{ field: 'cases.project.project_id', value: p.project.project_id }], false);
      ...
      <Row spacing={theme.spacing}>
        <EntityPageVerticalTable
          ...
          thToTd={[
            ...
            {
              th: 'Project ID',
              td: <ProjectLink uuid={p.project.project_id}>{p.project.project_id}</ProjectLink>,
            },
