...
const DoubleHelix: TDoubleHelix = ({
  ...
  <svg width={width} height={height} viewBox="0 0 20 35" version="1.1" style={{ fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: 1.41421 }}>
    <g id="_db_helix_clip1_Artboard2" transform="matrix(1,0,0,1,-2.10153,-2.12636)">
      ...
      <g clipPath="url(#_db_helix_clip1)">
        <g id="_db_helix_clip1_Artboard1" transform="matrix(1,0,0,1,-20.1958,-12.2937)">
