...
const Tabs = ({
  ...
  side ?
    <Row style={style} flex="1" {...props}>
      ...
      <Column style={{ ...styles.content(theme), flex: 1, ...(contentStyle || {}) }}>{children}</Column>
    </Row>
  :
    <Column style={style} {...props}>
      ...
      <Column style={{ ...styles.content(theme), ...(contentStyle || {}) }}>{children}</Column>
    </Column>
);
