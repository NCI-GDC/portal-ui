                ...
                thToTd={[
                  ...
                  { th: 'Archive', td: archiveComponent },
                  {
                    ...
                    td: projectIds.map(
                      pId =>
                        pId &&
                        <ProjectLink key={pId} uuid={pId}>{pId}</ProjectLink>,
                    ),
                  },
                ]}
              />
                    ...
                    { th: 'Workflow Type', td: node.analysis.workflow_type },
                    {
                      ...
                      td:
                        node.analysis.updated_datetime &&
                          moment(node.analysis.updated_datetime).format(
                            'YYYY-MM-DD',
                          ),
                    },
                    {
                      ...
                      td: node.analysis.input_files.hits.total === 1
                        ? <FileLink
                            uuid={
                              node.analysis.input_files.hits.edges[0].node
                                .file_id
                            }
                          >
                            1
                              ...
                              <AddToCartButtonSingle
                                file={{
                                  ...
                                  projects: [
                                    ...
                                    node.cases.hits.edges[0].node.project
                                      .project_id,
                                  ],
                                  acl: node.acl,
                                }}
