    ...
    switch (ctx) {
      case 'project': {
        return (
          <span>
            <b>{g.symbol}</b><br />
            {g.score.toLocaleString()} Case{g.score > 1 ? 's' : ''} affected in {projectId}<br />
            {g.score.toLocaleString()} / {numCasesAggByProject[projectId].toLocaleString()}
      ...
      case 'cohort': {
        return (
          <span>
            <b>{g.symbol}</b><br />
            {g.score.toLocaleString()} Case{g.score > 1 ? 's' : ''} affected in cohort<br />
