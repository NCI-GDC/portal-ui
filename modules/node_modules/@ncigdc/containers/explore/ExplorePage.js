    ...
    facetTabs={[
      {
        ...
        component: (
          <CaseAggregations
            ...
            suggestions={get(props, 'viewer.autocomplete_cases.cases.hits', { edges: [] })}
            setAutocomplete={
      ...
      },
      {
        ...
        component: (
          <GeneAggregations
            ...
            suggestions={get(props, 'viewer.autocomplete_genes.genes.hits', { edges: [] })}
            setAutocomplete={
      ...
      },
      {
        ...
        component: (
          <SSMAggregations
            ...
            suggestions={get(props, 'viewer.autocomplete_ssms.ssms.hits', { edges: [] })}
            setAutocomplete={
...
export const ExplorePageQuery = {
  ...
  fragments: {
    viewer: () => Relay.QL`
      fragment on Root {
        autocomplete_cases: explore @include(if: $runAutocompleteCases) {
          cases {
            hits(first:5, filters: $filters, query: $idAutocompleteCases) {
              edges {
                node {
                  id
                  case_id
        ...
        autocomplete_genes: explore @include(if: $runAutocompleteGenes) {
          genes {
            hits(first:5, filters: $filters, query: $idAutocompleteGenes) {
              edges {
                node {
                  id
                  symbol
        ...
        autocomplete_ssms: explore @include(if: $runAutocompleteSsms) {
          ssms {
            hits(first:5, filters:$filters, query:$idAutocompleteSsms) {
              edges {
                node {
                  id
                  ssm_id
        ...
        explore {
          ...
          cases {
            ...
            hits(first: $cases_size, offset: $cases_offset, filters: $filters, score: $cases_score) {
