...
const BiospecimenCard = ({
  ...
  const selectedEntity = Object.keys(selectedNode).length ? selectedNode : p.samples.hits.edges[0].node;
        ...
        <Column flex="3" style={{ padding: '0 15px' }}>
            <Row style={{ justifyContent: 'space-between' }}>
              ...
              <label htmlFor="search-biospecimen">
                <SearchIcon style={styles.searchIcon(theme)} /><Hidden>Search</Hidden>
              </label>
              <Input
          ...
          <Column style={{ padding: '10px' }}>
            <BioTreeView
              ...
              selectEntity={(selectedEntity, type) => setState(s => ({ ...s, selectedEntity, type: type.s, query: '' }))}
