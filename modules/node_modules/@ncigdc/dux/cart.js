...
function removeFilesFromCart(files) {
  return (dispatch, getState) => {
    ...
    dispatch(notify(getNotificationComponent('remove', `remove/${filesToRemove.file_name}`, {
      action: 'Removed',
      file: filesToRemove.file_name || filesToRemove.length,
...
export { toggleFilesInCart, addAllFilesInCart, removeAllInCart, removeFilesFromCart, fetchFiles };
