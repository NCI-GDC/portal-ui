      ...
      .directive('smartSearchWrapper', () => ({
        controller() {
          ...
          this.sendQuery = () => {
            const data = {
              query: this.query,
              filters: JSURL.stringify({ op: 'and', content: [this.gql.filters] }),
            };
            // need a timeout b/c angular is dirty-checking the route
            setTimeout(() => router.transitionTo(`/query/s?${queryString.stringify(data)}`));
          };
          this.resetQuery = () => {
            this.query = '';
            this.gql = null;
