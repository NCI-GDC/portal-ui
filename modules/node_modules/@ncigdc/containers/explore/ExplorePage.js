...
export const ExplorePageQuery = {
  ...
  fragments: {
    viewer: () => Relay.QL`
      fragment on Root {
        autocomplete_cases: cohort @include(if: $runAutocompleteCases) {
          cases {
        ...
        autocomplete_genes: cohort @include(if: $runAutocompleteGenes) {
          genes {
        ...
        autocomplete_ssms: cohort @include(if: $runAutocompleteSsms) {
          ssms {
