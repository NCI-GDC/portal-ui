...
const presetFacets = [
  ...
  { title: 'Primary Site', field: 'project.primary_site', full: 'cases.project.primary_site', doc_type: 'cases', type: 'keyword' },
...
export const CaseAggregationsComponent = (props: TProps) => (
  <div>
    <div className="text-right hidden" style={{ padding: '10px 15px', borderBottom: `1px solid ${props.theme.greyScale5}` }}>
      {
...
export const CaseAggregationsQuery = {
  ...
  prepareVariables: (prevVariables) => _.mapValues(prevVariables, (value, key) => (
    Object.keys(initialCaseAggregationsVariables).includes(key)
      ? (prevVariables.shouldRequestAllAggregations || value)
      : value
  )),
  fragments: {
