...
const drawChart = ({ data, yAxis, styles, width, height, colors, projectsIdtoName, dispatch }) => {
  ...
  const links = g.selectAll('.series')
    .data(stackedData)
    .enter().append('g')
      .attr('class', 'series')
    .selectAll('recet')
...
const StackedBarChart: TStackedBarChart = ({
  ...
  Object.keys(data).length
    ? drawChart({ data, yAxis, styles, colors, projectsIdtoName, width, height, dispatch })
    : (
