...
export const getDefaultCurve = memoize(async ({ slug, totalCases, currentFilters }: TPropsDefault): Promise<Object> => {
...
export const getSurvivalCurves = memoize(async ({ value, field, slug, currentFilters }: TPropsMulti): Promise<Object> => {
  const filters = [
    replaceFilters(
