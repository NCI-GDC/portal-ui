...
export default compose(
  ...
  withHandlers({
    handleUselessFacetVisibilityChange: ({ relay, setIsLoadingAdditionalFacetData, setShouldHideUselessFacets }) => (event) => {
      const shouldHideUselessFacets = event.target.checked;
  ...
  withPropsOnChange(['additionalFacetData'], ({ additionalFacetData }) => ({
    usefulFacets: _.omitBy(additionalFacetData, (aggregation) => _.some([
      aggregation.buckets && aggregation.buckets.length === 0,
      aggregation.count === 0,
    ])),
  })),
  ...
  <div>
    <div {...css(styles.header)}>
      ...
      <label tabIndex={0} role="button" className="pull-right">
        <input type="checkbox" onChange={props.handleUselessFacetVisibilityChange} />
