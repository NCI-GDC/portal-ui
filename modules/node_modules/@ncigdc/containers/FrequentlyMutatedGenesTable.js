...
const FrequentlyMutatedGenesTable = createRefetchContainer(
  FrequentlyMutatedGenesTableComponent,
  graphql.experimental`
      fragment FrequentlyMutatedGenesTable_explore on Explore
      @argumentDefinitions(
        fetchData: {type: "Boolean", defaultValue: false}
        fmgTable_filters: {type: "FiltersArgument"}
        fmgTable_size: {type: "Int", defaultValue: 10}
        fmgTable_offset: {type: "Int", defaultValue: 0}
        score: {type: "String", defaultValue: "case.project.project_id"}
        geneCaseFilter: {type: "FiltersArgument"}
        ssmTested: {type: "FiltersArgument"
        }
      ) {
        ssms {
          ...MutationsCount_ssms
