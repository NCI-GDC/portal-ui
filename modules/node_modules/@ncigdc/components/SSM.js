...
import ImpactIcon from '@ncigdc/components/ImpactIcon';
...
const Mutation = compose(
  ...
  const consequenceOfInterest = consequences.find(consequence => get(consequence, 'node.transcript.annotation'), {});
