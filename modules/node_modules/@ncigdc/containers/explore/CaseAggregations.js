...
import { initialECaseAggregationsVariables, exploreCaseAggregationsFragment } from '@ncigdc/utils/generated-relay-query-parts';
...
const presetFacets = [
  ...
  { title: 'Case Submitter ID', field: 'submitter_id', full: 'cases.submitter_id', doc_type: 'cases', type: 'id', placeholder: 'eg. TCGA-DD*, *DD*, TCGA-DD-AAVP' },
  ...
  { title: 'Race', field: 'demographic.race', full: 'cases.demographic.race', doc_type: 'cases', type: 'keyword' },
  { title: 'Ethnicity', field: 'demographic.ethnicity', full: 'cases.demographic.ethnicity', doc_type: 'cases', type: 'keyword' },
];
...
export const CaseAggregationsQuery = {
  ...
  prepareVariables: (prevVariables) => _.mapValues(prevVariables, (value, key) => (
    prevVariables.shouldRequestAllAggregations
      || initialECaseAggregationsVariables[key]
      || _.includes((tryParseJSON(window.localStorage.getItem(storageKey)) || []).map(x => escapeForRelay(x.field)), key.replace(/^shouldShow_/, ''))
      || value
  )),
  fragments: {
