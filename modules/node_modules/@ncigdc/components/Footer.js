  ...
  <footer style={styles.footer(theme)}>
    <div style={styles.outerContainer} role="contentinfo">
      <div style={styles.innerContainer}>
        ...
        <span> | </span>
        <ExternalLink href="http://www.cancer.gov/global/web/policies">Policies</ExternalLink>
        <span> | </span>
        <ExternalLink href="http://www.cancer.gov/global/web/policies/accessibility">Accessibility</ExternalLink>
        <span> | </span>
        <ExternalLink href="http://www.cancer.gov/global/web/policies/foia">FOIA</ExternalLink>
      </div>
      <div style={styles.innerContainer}>
        <ExternalLink href="http://www.hhs.gov">U.S. Department of Health and Human Services</ExternalLink>
        <span> | </span>
        ...
        <span> | </span>
        <ExternalLink href="http://www.usa.gov">USA.gov</ExternalLink>
      </div>
      <div style={styles.innerContainer}>
        NIH... Turning Discovery Into Health &#174;
      </div>
      <div style={styles.innerContainer}>
        <span> UI @ {uiVersion || (uiCommitHash || '').slice(0, 8)}</span>

        <span>, API {apiVersion}</span>
        {apiCommitHash && <span> @ {apiCommitHash.slice(0, 8)}</span>}
      </div>
    </div>
  </footer>
));
