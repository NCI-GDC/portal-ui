      ...
      {gene &&
        <Row style={{ marginBottom: '2rem', padding: '0 2rem', alignItems: 'center', height: '35px' }} spacing="1rem">
          ...
          <DownloadVisualizationButton
            svg={() => wrapSvg({
              selector: '#protein_viewer',
              title:
                `Gene: ${gene.symbol}, `
              + `Transcript: ${activeTranscript.transcript_id}(${activeTranscript.length_amino_acid} aa)`,
