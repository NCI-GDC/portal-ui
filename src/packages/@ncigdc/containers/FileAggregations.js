...
const presetFacets = [
  ...
  { field: 'experimental_strategy', full: 'files.experimental_strategy', type: 'keyword' },
  { title: 'Workflow Type', field: 'analysis.workflow_type', full: 'files.analysis.workflow_type', type: 'keyword' },
