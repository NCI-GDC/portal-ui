...
const Project = ({
  ...
  const experimentalStrategiesFilters = (value) => makeFilter([
    ...projectFilter,
    { field: 'files.experimental_strategy', value: [value] },
  ], true);

  const dataCategoriesFilters = (value) => makeFilter([
    ...projectFilter,
    { field: 'files.data_category', value: [value] },
  ], true);
          ...
          <SummaryCard
            ...
            data={
              experimentalStrategies.map((item, i) => {
                const builtFilters = experimentalStrategiesFilters(item.experimental_strategy);
          ...
          <SummaryCard
            ...
            data={
              dataCategories.map((item, i) => {
                const builtFilters = dataCategoriesFilters(item.data_category);
