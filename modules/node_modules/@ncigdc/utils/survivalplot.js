    ...
    legend: hasEnoughData ? [
      {
        ...
        value: (
          <span>
            S<sub>1</sub> (N = {rawData.results[0].donors.length.toLocaleString()}) - <Symbol>{slug || value}</Symbol> Mutated Cases
          </span>
        ),
      },
      {
        ...
        value: (
          <span>
            S<sub>2</sub> (N = {rawData.results[1].donors.length.toLocaleString()}) - <Symbol>{slug || value}</Symbol> Not Mutated Cases
          </span>
        ),
      },
    ] : [
