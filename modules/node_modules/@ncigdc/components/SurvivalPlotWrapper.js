          ...
          <Column>
            <Row style={{ justifyContent: 'flex-end', marginRight: '12px' }} spacing="1rem">
              <DownloadVisualizationButton
                svg={() => (
                  wrapSvg({
                    selector: '.survival-plot-container svg',
                    title: TITLE,
                    className: 'survival-plot',
                    embed: {
                      top: {
                        elements: [
                          legend ? document.querySelector('.survival-legend') : null,
                          pValue ? document.querySelector('.p-value') : null,
                        ],
                      },
                    },
                  })
            ...
            <div className="survival-legend">
              <Row style={{ justifyContent: 'center', flexWrap: 'wrap', marginTop: '0.5rem', textAlign: 'center' }}>
                {legend &&
                  legend.map((l, i) => (
                    <div
                      key={l.key}
