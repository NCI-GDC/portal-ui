    ...
    <Column style={styles.container} className="project-page">
      ...
      <Row style={{ flexWrap: 'wrap' }}>
        ...
        <Column style={{ ...styles.column, ...styles.margin }}>
          <CountCard
            title="CASES"
            count={formatNumber(project.summary.case_count)}
          ...
          <CountCard
            title="FILES"
            count={formatNumber(project.summary.file_count)}
          ...
          <CountCard
            title="ANNOTATIONS"
            count={formatNumber(project.annotations ? project.annotations.pagination.total : 0)}
