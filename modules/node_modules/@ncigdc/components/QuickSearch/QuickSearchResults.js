...
const ResultIcon = ({ type, style }) => ({
  case: <i style={style} className="fa fa-user" />,
  file: <i style={style} className="fa fa-file-o" />,
  project: <i style={style} className="fa fa-files-o" />,
  annotation: <i style={style} className="fa fa-align-left" />,
  'gene-centric': <i style={style} className="fa fa-square-o" />,
  'ssm-centric': <i style={style} className="fa fa-square-o" />,
}[type]);
...
export default ({ results = [], query, isLoading, onSelectItem, onActivateItem }: TProps) => (
  <ul style={{ ...styles.container }}>
    <li style={{ ...styles.item, position: 'fixed', backgroundColor: 'white', width: '406px', zIndex: 1 }}>
      {
        isLoading
      ...
      results.map((item, i) => (
        ...
        >
          <div style={styles.itemIconWrapper}>
            <ResultIcon type={item._type} style={styles.itemIcon} />
          </div>
          <div>
