...
import ImpactIcon, { impactColors } from '@ncigdc/theme/icons/ImpactIcon';
...
const mapData = (data: Array<Object>, projectId: string, shouldShowGeneSymbol: boolean): Array<Object> => (
  data.map((hit) => {
    const consequenceOfInterest = hit.consequence.hits.edges.find(consequence => get(consequence, 'node.transcript.annotation.impact'), {});
  ...
  lifecycle({
    componentDidMount() {
      this.props.relay.setVariables({
        ...
        fmTable_size: parseIntParam(this.props.query.fmTable_size, 10),
