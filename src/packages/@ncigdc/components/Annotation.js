  ...
  <Column spacing={theme.spacing}>
    <EntityPageVerticalTable
      ...
      thToTd={[
        ...
        { th: 'Case UUID', td: <CaseLink uuid={node.case_id}>{node.case_id}</CaseLink> },
        { th: 'Case Submitter ID', td: node.case_submitter_id },
        { th: 'Project ID', td: <ProjectLink uuid={node.project.project_id}>{node.project.project_id}</ProjectLink> },
