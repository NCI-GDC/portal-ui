...
import { withState, withProps, lifecycle, withHandlers } from 'recompose';

export default [
  withState('shouldShowFacetSelection', 'setShouldShowFacetSelection', false),
  withState('userSelectedFacets', 'setUserSelectedFacets', []),
  withProps(({ userSelectedFacets, setUserSelectedFacets, storageKey, presetFacetFields, validFacetDocTypes }) => ({
