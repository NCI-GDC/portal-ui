...
export const RepositoryPageComponent = (props: TProps) => {
  ...
  const fileSize = props.viewer.summary.aggregations.fs.value;
        ...
        results={
          <span>
            ...
            >
              ...
              <span style={{ flex: 'none' }}><CaseIcon outline style={{ marginRight: 5 }} /> <strong>{caseCount.toLocaleString()}</strong> cases</span>
              <span style={{ flex: 'none' }}><FileIcon text style={{ marginRight: 5 }} /> <strong>{fileCount.toLocaleString()}</strong> files</span>
              <span style={{ flex: 'none' }}><SaveIcon style={{ marginRight: 5 }} /> <strong>{formatFileSize(fileSize)}</strong></span>
            </Row>
            <TabbedLinks
