...
export const simpleAggCache = {};
export const pendingAggCache = {};
export const DEFAULT_CONTINUOUS_BUCKETS = 5;

export const componentName = 'ContinuousAggregationQuery';
...
const getContinuousAggs = ({
  ...
  const body = makeBody({ aggregationFieldName, variables });
