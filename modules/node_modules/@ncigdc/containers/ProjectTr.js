...
export const ProjectTrComponent = ({ node, index, theme }: TProps) => {
  ...
  return (
    ...
    >
      ...
      <Td>
        <CasesLink>{node.summary.case_count}</CasesLink>
      </Td>
      <Td>
        <CasesLink
          fields={[{ field: 'files.data_category', value: CATEGORY_MAP.Seq }]}
        >
          {findDataCategory('Seq', node.summary.data_categories).case_count}
        </CasesLink>
      </Td>
      <Td>
        <CasesLink
        ...
        >
          {findDataCategory('Exp', node.summary.data_categories).case_count}
        </CasesLink>
      </Td>
      <Td>
        <CasesLink
        ...
        >
          {findDataCategory('SNV', node.summary.data_categories).case_count}
        </CasesLink>
      </Td>
      <Td>
        <CasesLink
        ...
        >
          {findDataCategory('CNV', node.summary.data_categories).case_count}
        </CasesLink>
      </Td>
      <Td>
        <CasesLink
        ...
        >
          {findDataCategory('Clinical', node.summary.data_categories).case_count}
        </CasesLink>
      </Td>
      <Td>
        <CasesLink
        ...
        >
          {findDataCategory('Bio', node.summary.data_categories).case_count}
        </CasesLink>
      </Td>
      <Td>
        <RepositoryFilesLink
