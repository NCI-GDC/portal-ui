...
import CohortCasesPies from '@ncigdc/components/TabPieCharts/CohortCasesPies';
        ...
        links={[
          {
            ...
            component: (
              !!props.viewer.cohort.cases.hits.total
              ? <CasesTab
                cohort={props.viewer.cohort}
          ...
          },
          {
            ...
            component: (
              props.viewer.cohort.genes.hits.total
              ? <GenesTab
                viewer={props.viewer}
              />
          ...
          },
          {
            ...
            component: (
              props.viewer.cohort.ssms.hits.total
              ? <MutationsTab
  ...
  fragments: {
    viewer: () => Relay.QL`
      fragment on Root {
        ...
        projectBreakdownFragment: cohort {
          ${ProjectBreakdown.getFragment('cohort')}
        }
        cohort {
          ...
          cases {
            aggregations(filters: $filters) {
              ...
              ${CohortCasesPies.getFragment('aggregations')}
            }
