...
const PortalContainer = ({ isBannerDismissed }) => (
  <div style={{ position: 'relative', minHeight: '100vh' }}>
    <Header />
    <div style={{ ...(isBannerDismissed ? {padding: '51px 0 120px 0'} : {padding: '91px 0 120px 0'}), transition: 'padding 0.5s ease' }}>
 ...
 export default connect(store => store.dismissBanner)(PortalContainer);