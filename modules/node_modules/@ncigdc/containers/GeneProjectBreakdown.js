...
import caseHasMutationFilter from '@ncigdc/utils/filters/prepared/caseHasMutation';
...
export const GeneProjectBreakdownQuery = {
  initialVariables: {
    fetchData: false,
    filters: null,
    totalCasesFilter: caseHasMutationFilter,
  },
  fragments: {
    cohort: () => Relay.QL`
      fragment on Cohort {
        cases { hits(first: 1 filters: $totalCasesFilter) { total } }
