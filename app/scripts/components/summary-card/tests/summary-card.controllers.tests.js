describe('Summary Card Controller:', function () {
  ...
  describe('addFilters:', function () {
    ...
    it('should return undefined if no filters in config', inject(function ($rootScope, $controller, LocationService) {
    ...
    it('should be called correctly', inject(function ($rootScope, $controller, LocationService) {
      var scope = $rootScope.$new();
      scope.config = {
