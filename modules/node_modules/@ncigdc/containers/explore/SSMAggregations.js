...
const presetFacets = [
  ...
  { title: 'Impact (VEP)', field: 'consequence.transcript.annotation.impact', full: 'ssms.consequence.transcript.annotation.impact', doc_type: 'ssms', type: 'terms' },
  ...
  { title: 'SSM Callers', field: 'occurrence.case.observation.variant_calling.variant_caller', full: 'ssms.occurrence.case.observation.variant_calling.variant_caller', doc_type: 'ssms', type: 'terms' },
  { title: 'COSMIC ID', field: 'cosmic_id', full: 'ssms.cosmic_id', doc_type: 'ssms', type: 'notMissing' },
  { title: 'dbSNP rs ID', field: 'consequence.transcript.annotation.dbsnp_rs', full: 'ssms.consequence.transcript.annotation.dbsnp_rs', doc_type: 'ssms', type: 'notMissing' },
];
