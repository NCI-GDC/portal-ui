...
const drawChart = ({ data, yAxis, styles, width, height, colors, projectsIdtoName }) => {
    ...
    .enter().append('a')
      ...
      .attr('y', d => y(d[1]))
      .attr('fill', d => colors ? colors[d[2].key] : 'black')
...
let StackedBarChart = (() => {
  return ({ data, yAxis, styles, colors, projectsIdtoName, width = 450, height = 200 }) => {
    return Object.keys(data).length ?
      drawChart({ data, yAxis, styles, colors, projectsIdtoName, width, height }) :
