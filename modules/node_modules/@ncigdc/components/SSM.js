...
const Mutation = compose(
  ...
  const sortedCancerDistData = Object.keys(cancerDistData) // eslint-disable-line fp/no-mutating-methods
  ...
  const consquenceDataMapped = Object.values(consequenceDataGrouped).map(d => {
    ...
    return {
      ...
      strand: strandIconMap[first.gene.gene_strand.toString(10)],
      transcripts: (
        <CollapsibleList
          style={{ width: '150px' }}
