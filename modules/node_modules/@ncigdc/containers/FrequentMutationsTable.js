...
const mapData: TMapData = (data, shouldShowGeneSymbol, theme) => (
  data.map(hit => {
    ...
    const { annotation = {}, consequence_type: consequenceType = '', gene = {}, aa_change: aaChange } = transcript || {};
    ...
    return {
      ...
      consequence_type: (
        <span>
          ...
          {
            // for tsv export, excel displays nbsp incorrectly and span margins don't show up
...
const FrequentMutationsTableComponent = compose(
  ...
  const frequentMutations = !ssms ? [] :
    mapData(ssms.hits.edges.map(x => x.node), shouldShowGeneSymbol, theme);
      ...
      <Row style={{ backgroundColor: 'white', padding: '1rem', justifyContent: 'space-between' }}>
        ...
        <Row>
          ...
          <DownloadTableToTsvButton
            ...
            filename="frequent-mutations.tsv"
            selector="#frequent-mutations-table"
          />
        </Row>
      </Row>
