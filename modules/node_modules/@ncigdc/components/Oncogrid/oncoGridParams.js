...
function getSquare(field: Object): string {
...
function clinicalLegend(maxDaysToDeath: number): string {
  return `
...
function gdcLegend(maxValue: number): string {
