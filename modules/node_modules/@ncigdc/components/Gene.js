...
const Gene = compose(
  ...
  connect(),
  withProps({
    renderProteinLolliplot(data, transcript, { setState, dispatch }): void {
  ...
  lifecycle({
    async componentDidMount(): Promise<*> {
      ...
      console.log(123, data, transcript)
      ...
      <Row spacing="2rem">
        <EntityPageVerticalTable
          ...
          thToTd={[
            ...
            {
              th: 'Location',
              td: `chr${gene.gene_chromosome}:${gene.gene_start}-${gene.gene_end} (${((((gene.case || [])[0] || {}).ssm || [])[0] || {}).ncbi_build})`,
            },
