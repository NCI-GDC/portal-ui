...
const OncoGridWrapper = compose(
  ...
  withProps({
    ...
    async getQueries({
      ...
      console.log(123123, currentImpacts)
      ...
      const gridParams = oncoGridParams({
        ...
        width: containerRefs[state.uniqueGridClass].offsetWidth - oncoGridPadding,
  ...
  lifecycle({
    componentWillReceiveProps(nextProps: Object): void {
      ...
      if (this.props.currentFilters !== nextProps.currentFilters) {
