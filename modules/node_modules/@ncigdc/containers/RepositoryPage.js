        ...
        facetTabs={[
          {
            ...
            component: (
              <CaseAggregations
                ...
                suggestions={(props.viewer.autocomplete_case || { cases: { hits: { edges: [] } } }).cases.hits}
          ...
          },
          {
            ...
            component: (
              <FileAggregations
                ...
                suggestions={(props.viewer.autocomplete_file || { files: { hits: { edges: [] } } }).files.hits}
...
export const RepositoryPageQuery = {
  ...
  fragments: {
    viewer: () => Relay.QL`
      fragment on Root {
        autocomplete_case : repository @include(if: $runAutocompleteCase) {
          cases {
            hits(first:5, filters: $filters, query: $idAutocompleteCase) {
              edges {
                node {
                  id
                  case_id
        ...
        autocomplete_file: repository @include(if: $runAutocompleteFile) {
          files {
            hits(first:5, filters: $filters, query: $idAutocompleteFile) {
              edges {
                node {
                  id
                  file_id
