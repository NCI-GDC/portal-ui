...
const FrequentMutationsChartComponent = compose(
  ...
  const bandWidth = (
    ...
    (ssms.hits.edges.length + 1) / (showSurvivalPlot ? 1 : 2)
  ) * 0.7;
    ...
    <span>
      {!!ssms.hits.edges.length && <span style={{ flex: 1 }}>
        ...
        <div
          style={{
            ...graphTitle(),
            width: showSurvivalPlot ? width : ((width / 2) - chartMargin.left - chartMargin.right),
          }}
        >
          Distribution of Most Frequent Mutations
        </div>
