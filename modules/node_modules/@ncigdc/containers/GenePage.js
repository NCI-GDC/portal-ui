  ...
  withPropsOnChange(['node'], ({ node }) => ({
    fmFilters: makeFilter([
      ...
      },
      {
        ...
        value: [(node.transcripts.hits.edges.find(x => x.node.is_canonical) || {}).node.transcript_id],
      },
    ], false),

    cdFilters: makeFilter([
      { field: 'gene.gene_id', value: node.gene_id },
  ...
  >
    <Column spacing="2rem">
      ...
      <Column style={styles.card} id="cancer-distribution">
        ...
        <Column>
          <CancerDistributionChart
            cases={props.viewer.cohort.cases}
            projects={props.viewer.projects}
            filters={props.cdFilters}
          />
          <CancerDistributionTable
            ...
            cases={props.viewer.cohort.cases}
            projects={props.viewer.projects}
            cohort={props.viewer.cancerDistributionTableCohortFragment}
          />
        </Column>
      </Column>
      ...
      <Column style={{ ...styles.card, marginTop: '2rem' }}>
        ...
        {props.node.biotype !== 'protein_coding' &&
          <div>No mutation occurs in the coding region of this gene.</div>
        }
      </Column>
