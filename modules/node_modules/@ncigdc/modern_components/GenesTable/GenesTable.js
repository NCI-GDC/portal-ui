...
class GenesTableRoute extends Relay.Route {
  static routeName = 'GenesTableRoute';
  static queries = viewerQuery;
  static prepareParams = ({ location: { search }, defaultSize } ) => {
    const q = parse(search);

    return {
      genesTable_filters: parseFilterParam(q.genesTable_filters, null),
      genesTable_offset: parseIntParam(q.genesTable_offset, 0),
      genesTable_size: parseIntParam(q.genesTable_size || defaultSize, 20),
...
export default compose(
  ...
  <Relay.Renderer
    ...
    queryConfig={new GenesTableRoute(props)}
    onReadyStateChange={handleStateChange(props)}
    Container={Container}
    render={({ props: relayProps }) => (
      relayProps ? <Container {...relayProps} {...props} /> : undefined
    )}
  />
));
