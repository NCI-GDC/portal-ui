 ...
 dispatch,
  ...
  <Row style={{ alignSelf: 'stretch' }}>
    ...
    >
      <DropdownItem
        onClick={() => {
          const numProjects = Object.keys(user.projects || {})
            .reduce((acc, k) => [...acc, ...user.projects[k]], []).length;
            ...
            dispatch(notify(
              {
                ...
                component: (
                  <span>
                    {user.username} does not have access to any protected data within the GDC.
                    Click <a href="https://gdc.nci.nih.gov/access-data/obtaining-access-controlled-data">here</a>
