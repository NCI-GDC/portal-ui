              ...
              {width &&
                <div>
                  <Lolliplot
                    ...
                    getPointColor={
                      d => mutationColors[blacklist][d[blacklist]]
                    }
                    data={lolliplotData.mutations.filter(d =>
                      d.x > min && d.x < max
                    ).filter(filterByType(blacklist))}
                    onPointClick={d => { push(`/ssms/${d.id}`); }}
                  ...
                  <div style={{ marginTop: '-20px' }}>
                    <Backbone
                      ...
                      onProteinClick={d => setState(s => ({ ...s, min: d.start, max: d.end }))}
                    ...
                    <Minimap
                      ...
                      data={{
                        ...lolliplotData,
                        mutations: lolliplotData.mutations.filter(filterByType(blacklist)),
                      }}
                    />
                  </div>
                </div>
                  ...
                  >
                    <Row>
                      <span
                        ...
                        style={{ color: 'rgb(27, 103, 145)', cursor: 'pointer' }}
                      >
                        Select All
                      </span>
                      <span>&nbsp;|&nbsp;</span>
                      <span
                        onClick={() => {
                          fillBlacklist(Object.keys(groupByType(blacklist, lolliplotData.mutations)));
                        }}
                        style={{ color: 'rgb(27, 103, 145)', cursor: 'pointer' }}
                      >
                        Deselect All
