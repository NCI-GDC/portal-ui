              ...
              <BucketRow>
                <BucketLink
                  ...
                  query={{
                    offset: 0,
                    filters: { op: 'and',
                      content: [{ op: 'not', content: { field: dotField, value: ['missing'] } }],
                    },
                  }}
                >
                  <input
                    ...
                    checked={currentFilters.some(({ op, content: { field, value } }) =>
                      op === 'not' && field === dotField && value.includes('missing')
                    )}
                ...
                <CountBubble>{props.notMissingDocCount.toLocaleString()}</CountBubble>
              </BucketRow>
            </Column>
          }
        </Container>
