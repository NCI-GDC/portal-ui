...
import { store } from 'webpack_entry/Portal';
...
const progressChecker = (
  ...
  const detailedMessage = (
    <div>
      ...
      <div>
        We recommend that you use the <a href="https://gdc.cancer.gov/access-data/gdc-data-transfer-tool" target="_blank"> GDC Data Transfer Tool
