                ...
                <DownloadVisualizationButton
                      ...
                      embed: {
                        top: {
                          elements: [
                            ...
                            pValue ? document.querySelector(`.${uniqueClass} .p-value`) : null,
                          ],
                        },
                      },
                    })
                  ...
                  tsvData={
                    results.reduce((data, set) => {
                      ...
                      return [
                        ...data,
                        ...(results.length > 1 ? mapData.map((m) => m.set('label', set.meta.label)) : mapData),
                      ];
                    }, [])
                  }
                />,
            ...
            </div>
            {
              <div className="p-value">
                <div style={styles.pValue}>
                  {_.isNumber(pValue) && `Log-Rank Test P-Value = ${pValue.toExponential(2)}`}
                </div>
              </div>
            }
            <div
