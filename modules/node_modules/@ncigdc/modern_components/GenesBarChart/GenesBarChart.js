...
class Route extends Relay.Route {
  ...
  static prepareParams = ({ location: { search }, defaultFilters = null }) => {
    ...
    return {
      genesBarChart_filters: parseFilterParam(q.genesBarChart_filters, defaultFilters),
    };
  }
}
...
const Component = compose(
  ...
  viewer: { explore: { genes = { hits: { edges: [] } }, cases, filteredCases } },
