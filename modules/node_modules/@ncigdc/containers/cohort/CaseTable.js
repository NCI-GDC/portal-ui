        ...
        <table style={styles.table}>
          <thead>
            <Tr>
              ...
              <Th colSpan="6" style={styles.center}>Available Cases per Data Category</Th>
              <Th rowSpan="2" style={styles.right}>Mutations</Th>
              <Th rowSpan="2" style={styles.right}>Genes</Th>
            </Tr>

            <Tr>
              <Th style={styles.right}>Seq</Th>
              <Th style={styles.right}>Exp</Th>
              <Th style={styles.right}>SNV</Th>
              <Th style={styles.right}>CNV</Th>
              <Th style={styles.right}>Clinical</Th>
              <Th style={styles.right}>Bio</Th>
            </Tr>
          </thead>
          <tbody>
            {props.hits.edges.map((e, i) => (
              <CaseTr {...e} key={e.node.id} index={i} cohort={props.cohort} />
            ))}
          </tbody>
        </table>
      </div>
