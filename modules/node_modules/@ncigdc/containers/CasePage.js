    ...
    <LocationSubscriber>
      {
        (ctx: {| pathname: string, query: TRawQuery |}) => (
          <Case
            ...
            ssmTested={_.get(viewer.cohort.cases.hits, 'edges[0].node.available_variation_data', []).includes('ssm')}
            files={
            ...
            numCasesAggByProject={
              viewer.cohort.cases.aggregations.project__project_id.buckets.reduce((acc, b) => ({
                ...acc,
                [b.key]: b.doc_count,
              }), {})
            }
