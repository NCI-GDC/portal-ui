...
const drawChart = ({ data, yAxis, xAxis, width, height, colors, projectsIdtoName, setTooltip, theme }) => {
  ...
  xG.selectAll('path')
    .style('stroke', xAxisStyle.stroke);
  xG.selectAll('line')
    .style('stroke', xAxisStyle.stroke);
  ...
  yG.selectAll('path')
    .style('stroke', yAxisStyle.stroke);
  yG.selectAll('line')
    .style('stroke', yAxisStyle.stroke);
  yG.selectAll('text')
    .style('fontWeight', yAxisStyle.fontWeight)
...
const StackedBarChart: TStackedBarChart = ({
  ...
  Object.keys(data).length
    ? drawChart({ data, yAxis, xAxis, styles, colors, projectsIdtoName, width, height, setTooltip, theme })
    : (
