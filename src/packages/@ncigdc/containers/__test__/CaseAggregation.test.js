...
describe('prepareVariables', () => {
  it('should return all fields as true if shouldRequestAllAggregations is true', () => {
    ...
    expect(_.every(_.values(CaseAggregationsQuery.prepareVariables(testVarsA)))).toBe(true);
    ...
    expect(_.every(_.values(CaseAggregationsQuery.prepareVariables(testVarsB)))).toBe(true);
  });
  ...
  it('should return all fields as false if all fields were already false', () => {
    ...
    expect(_.every(_.values(CaseAggregationsQuery.prepareVariables(testVars)))).toBe(false);
  });
