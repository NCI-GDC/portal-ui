...
export REACT_APP_SLIDE_IMAGE_ENDPOINT="https://uat-api.gdc.cancer.gov/tile/"
export REACT_APP_COMMIT_HASH=`git rev-parse --short HEAD`
export REACT_APP_COMMIT_TAG=`git tag -l --points-at HEAD`
export REACT_APP_API="https://uat-portal.gdc.cancer.gov/auth/api/v0/"
export REACT_APP_GDC_AUTH="https://uat-portal.gdc.cancer.gov/auth/"
export GDC_BASE="/"
