...
const GDCAppsDropdown = () => {
  return (
    <Dropdown
      className="gdc-apps-menu-container"
      style={{
        margin: 0,
        border: 'none',
        color: '#777',
      ...
      shouldDropdownItem={false}
      buttonWithIcon={
        <span className={baseStyle.dropDownButton}>
    ...
    >
      <Row
        className={baseStyle.dropDown}
      >
        <Column>
          <Row
            className={`active ${baseStyle.dropDownItem}`}
          >
            <ExternalLink
          ...
          <Row className={baseStyle.dropDownItem}>
            <ExternalLink
              hasExternalIcon={false}
