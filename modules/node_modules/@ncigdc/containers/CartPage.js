...
import CartDownloadButton from '@ncigdc/components/CartDownloadButton';
    ...
    <Column style={styles.container}>
      ...
      {!!files.length && !!viewer.repository.files.hits &&
        <Column>
          <Row spacing="2rem" style={{ marginBottom: '2rem' }}>
            ...
            <SummaryCard
              ...
              data={
                ...
                //   return {
                //     ...item,
                //     file_count: <a href={`/search/f?filters=`}>{item.file_count.toLocaleString()}</a>,
                //     file_count: <a href={`/search/f?filters=`}>{item.file_count.toLocaleString()}</a>,
                //   };
                // })
              ...
              footer={`${viewer.summary.aggregations.project__project_id.buckets.length} Authorization Levels`}
              path="file_count"
              headings={[
                // { key: 'access', title: 'Level',olor: true },
                // {
                //   key: 'file_count',
                //   title: 'Files',
          ...
          <FileTable hits={viewer.repository.files.hits} downloadable={false} />
        </Column>
      }
    </Column>
  );
