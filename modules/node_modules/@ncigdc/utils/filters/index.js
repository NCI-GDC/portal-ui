...
export const mergeQuery: TMergeQuery = (q, ctx, mergeType, whitelist) => {
  const ctxq = ctx || {};
  const qq = q || {};
  const ctxqq = whitelist ? filterByWhitelist(ctxq, whitelist) : ctxq;

  return ({
    ...ctxqq,
    ...qq,
    filters: (mergeFns(mergeType))(qq.filters, parseFilterParam(ctxq.filters, null)),
  });
};
